...
est.prob.detected.n.miRs <- drr.all.plasma.filt[,
                                                .(n.detected=.N[est.prob.detected>min.prob.detected],
                                                  n.not.detected=.N[est.prob.detected<=min.prob.detected],
                                                  n.total=.N),
                                                by=.(MT.Unique.ID,downsample.to,Source)]
# Plasma miRs detected
est.prob.detected.n.miRs.log10 <- est.prob.detected.n.miRs[, downsample.to.f:=factor(round(log10(downsample.to), 1), levels=rev(downsample.to.vec))]
ggplot(est.prob.detected.n.miRs.log10, aes( x=downsample.to, y=n.detected)) + 
  geom_boxplot(aes(group=downsample.to)) + ggtitle("Library Downsampling")

'g <- ggplot(est.prob.detected.n.miRs, aes( x=downsample.to, y=n.detected, fill=Source)) + 
  ...
  labs(x=NULL, y="# miRNAs detected in all samples", strip="log10 Sequencing Depth (total miRNA-mapping reads)") +
